...
*/
    ...
    return isLoading ? (
        ...
        <div className="flex flex-col items-center justify-start w-full min-h-screen max-w-6xl px-4 py-6 overflow-y-auto">
                ...
                {soldierOptics.length > 0 && (
                    <div className="mt-4">
                        ...
                        >
                            ...
                            {soldierOptics.map((optic: { key: any; value: any; }, idx: React.Key | null | undefined) => (
